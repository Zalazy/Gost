...
```bash
wget --no-check-certificate -O gost.sh https://raw.githubusercontent.com/Zalazy/Gost/refs/heads/main/gost.sh && chmod +x gost.sh && ./gost.sh
```
...
* 注：由于 Gost v2.11.5 版本功能稳定，此脚本将一直采用该版本，后续不再跟随官方更新（ https://github.com/ginuerzh/gost/releases#release-v2.11.5 ）
